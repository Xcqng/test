...
Usage: node ${path.basename(__filename)} <http://example.com> <60>\n`.brightYellow);
	...
	console.log("CloudFlareBypass By OhayoOniiChan".brightBlue);
    process.exit(0);
}

const target = process.argv[2],
    time = process.argv[3];
console.log("[".brightBlue,"OhayoOniiChan".brightYellow,"]".brightBlue,">".brightBlue,"Start Attack.".brightYellow)	;
